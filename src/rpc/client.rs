...
use crate::{
    ...
    rpc::{client_async::BrokerClientAsync, tls_helper::Cert, BrokerConfig, Message},
};
...
impl BrokerClient {
    ...
    pub fn new_with_runtime(
        ...
        let client = BrokerClientAsync::new(config, cert, allow_list);
        Ok(Self { rt, client })
    }
